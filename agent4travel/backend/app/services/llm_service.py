...
**重要要求：**
1. **location_name** 必须是详细、真实、可查询的具体地址，包含城市、区域、街道或地标信息
2. 每个活动都应该包含预估花费（人民币）
3. 提供具体的景点名称、餐厅名称或酒店名称，而不是泛称
4. 预算分析要详细到具体项目和金额
...
{{
        ...
        {{
            ...
            "activities": [
                {{
                    "time": "09:00",
                    "activity": "抵达东京成田机场",
                    "description": "办理入境手续，兑换货币",
                    "location_name": "东京成田国际机场第1航站楼",
                    "estimated_cost": 500
                }},
                {{
                    "time": "14:00",
    ...
    "budget_analysis": "根据5天行程和1万元预算：住宿4000元（800元/晚×5晚），餐饮1500元（300元/天），交通800元（160元/天），门票娱乐2500元（500元/天），购物1200元（240元/天），总计10000元。"
}}
